...
class CharacterService {
  ...
  Character initCharacter(String name, Creature creature){
    ...
    return Character(name: name, creatureName : creature.name, creatureId: creature.id,
        ...
        wisdom: creature.wisdom, charisma: creature.charisma, hpMax: hpMax, hpCurrent: hpCurrent, ca: creature.ca);
  }

  Character initNewCharacter(){
    return Character(name: '',strength: 0, dexterity: 0, constitution: 0, intelligence: 0, wisdom: 0, charisma: 0, hpMax: 0, hpCurrent: 0, ca: 0);
  }
